    ...
    >
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-20 sm:py-28">
        <div className="max-w-3xl mx-auto text-center reveal">
          ...
          <p className="font-mono text-[11px] tracking-[0.2em] uppercase text-gold mb-6">{eyebrow}</p>

          <h2 className="font-black text-[clamp(36px,5.5vw,80px)] text-white leading-none tracking-tight mb-8">
            {headingLine1}<br />
            <span className="text-gold">{headingLine2 ?? "Let's talk steel."}</span>
          </h2>

          <p className="text-[16px] text-white/50 leading-relaxed max-w-xl mx-auto mb-12">
            From bulk orders and delivery scheduling to tender submissions and trade accounts — our team responds within 24 hours.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-white border border-white/20 hover:border-white/40 font-semibold text-[15px] px-8 py-4 transition-all duration-200 cursor-pointer"
            >
          ...
          >
            ...
            >
              ...
              <span className="text-[15px] font-semibold text-white group-hover:text-gold transition-colors duration-200">{phone}</span>
              <span className="text-[10px] text-white/30 font-mono uppercase tracking-[0.15em]">Call or WhatsApp</span>
            </a>
            ...
            >
              ...
              <span className="text-[15px] font-semibold text-white group-hover:text-gold transition-colors duration-200">{email}</span>
              <span className="text-[10px] text-white/30 font-mono uppercase tracking-[0.15em]">Email us</span>
            </a>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-[15px] font-semibold text-white">Dar es Salaam, Tanzania</span>
              <span className="text-[10px] text-white/30 font-mono uppercase tracking-[0.15em]">Headquarters</span>
            </div>
          </div>
        </div>
      </div>
