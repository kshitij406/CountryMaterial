        ...
        <div className="max-w-3xl mx-auto text-center reveal">
          ...
          >
            ...
            >
              ...
              <span className="text-[10px] text-white/30 font-mono uppercase tracking-[0.15em]">{t.callOrWhatsapp}</span>
            </a>
            ...
            >
              ...
              <span className="text-[10px] text-white/30 font-mono uppercase tracking-[0.15em]">{t.emailUs}</span>
            </a>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-[10px] text-white/30 font-mono uppercase tracking-[0.15em]">{t.headquarters}</span>
            </div>
          </div>
        </div>
      </div>
