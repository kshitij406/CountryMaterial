  ...
  return (
    <section className="relative bg-navy overflow-hidden py-20 lg:py-28">
      ...
      <div ref={ref} className="opacity-0 relative max-w-container mx-auto px-6 lg:px-10 text-center">
        <h2 className="font-heading text-4xl lg:text-6xl text-white leading-tight mb-6 max-w-3xl mx-auto">
          {heading}
        </h2>
        <p className="font-body text-white/60 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
          {subtext}
        </p>
