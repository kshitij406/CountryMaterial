  ...
  return (
    ...
    >
      <div className="text-center max-w-lg reveal">
        <div className="font-display text-[120px] leading-none text-gold/15 mb-4">404</div>
        <div className="w-16 h-px bg-gold mx-auto mb-6" />
        <h1 className="font-display text-[clamp(32px,5vw,56px)] leading-[0.95] tracking-[0.04em] uppercase text-cream mb-5">
          Page Not Found
        </h1>
        <p className="font-barlow text-[16px] text-cream/50 leading-[1.65] mb-10">
