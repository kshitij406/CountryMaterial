...
export default async function SiteLayout({
  ...
  return (
    <>
      <RevealObserver />
      <Navbar logoUrl={logoUrl} locale={locale} t={t.nav} phone={settings?.phone} />
      <PageTransition>
        <main>{children}</main>
      </PageTransition>
      <Footer contact={contact} locale={locale} t={t.footer} />
      <FloatingActions whatsapp={settings?.whatsapp} video={settings?.floatingVideo} t={t.floating} />
    </>
  )
}
