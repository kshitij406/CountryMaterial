...
const BRANCH_CITIES = ['Dar es Salaam', 'Mbeya', 'Dodoma', 'Kahama', 'Pwani', 'Kilimanjaro']
...
export default async function ContactPage({ params }: { params: { locale: string } }) {
  ...
  const branches = BRANCH_CITIES.map((name, i) => ({
    name,
    note: t.branchNotes[i],
    hours: i === 0 ? t.hours24 : t.hoursStandard,
  }))
  ...
  return (
    <>
      ...
      {/* Contact grid */}
      <section className="py-16 sm:py-20" style={{ background: '#FAF7F2' }} aria-label={t.sectionLabel}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="p-7 border" style={{ background: '#FFFFFF', borderColor: '#E8DED1' }}>
                <h2 className="font-black text-[17px] text-ink mb-6">{t.directContact}</h2>
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-slate/45 mb-1">{t.phoneLabel}</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-slate/45 mb-1">{t.emailLabel}</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-slate/45 mb-1">{t.hqLabel}</p>
              ...
              {/* Branches */}
              <div className="p-7 border" style={{ background: '#FFFFFF', borderColor: '#E8DED1' }}>
                <h2 className="font-black text-[17px] text-ink mb-5">{t.allBranches}</h2>
            ...
            <div className="p-8 border" style={{ background: '#FFFFFF', borderColor: '#E8DED1' }}>
              <h2 className="font-black text-[20px] text-ink mb-2">{t.formHeading}</h2>
              <p className="text-[14px] text-slate/55 mb-7">{t.formIntro}</p>
              <ContactForm t={dict.contactForm} />
            </div>
          </div>
        </div>
      </section>
